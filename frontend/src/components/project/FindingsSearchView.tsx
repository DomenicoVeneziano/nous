...
/* Local to this view: the shared `.data-table` rule is the asset grid's chrome
 * (sticky --bg-elevated header, 10/16 and 9/16 padding, 14px cells). This
 * results table is the compact 12px variant with no sticky header. */
