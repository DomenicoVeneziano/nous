...
/* Local to this panel: the shared `.input` rule is the page-level field (13px,
 * --bg-base, 11px/14px padding). These inline fields are the compact mono
 * variant, so adopting it would visibly resize every finding form control. */
