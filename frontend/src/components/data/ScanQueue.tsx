...
// The queue is unbounded server-side, so the list scrolls internally rather than driving page height.
const QUEUE_LIST_MAX_HEIGHT = 460;
...
export default function ScanQueue({ jobs, onRefresh }: Props) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        flex: 1, minHeight: 0, overflowY: 'auto', maxHeight: QUEUE_LIST_MAX_HEIGHT,
      }}>
        {jobs.length === 0 ? (
          <div style={{
